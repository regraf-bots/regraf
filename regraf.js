const debug = require('debug')('regraf:core')
...
class Regraf extends Composer {
  ...
  launch (config = {}) {
    ...
    return this.telegram.getMe()
      .then((botInfo) => {
        ...
        const hookPath = config.webhook.hookPath || `/regraf/${crypto.randomBytes(32).toString('hex')}`
  ...
  handleUpdate (update, webhookResponse) {
    ...
    const RegrafContext = this.options.contextType
    const ctx = new RegrafContext(update, tg, this.options)
...
module.exports = Object.assign(Regraf, {
  Context,
  Composer,
  default: Regraf,
  Extra,
